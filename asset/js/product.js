...
var productApi = 'https://db-98xw.onrender.com/products'
var cartApi = 'https://db-98xw.onrender.com/cart'
var products;
var cart;
...
function postCart(cart_item) {
    ...
    fetch("https://db-98xw.onrender.com/cart", option)
        .then(function (response) {
            return response.json();
        })
        .then(function (data) {
...
function putCart(cart_item) {
    ...
    fetch("https://db-98xw.onrender.com/cart/" + cart_item.id, option)
        .then(function (response) {
            return response.json();
        })
        .then(function (data) {
